...
export const LoadingSpinner: React.FC = () => {
  return (
    <div
      role="status"
      aria-live="polite"
      className="min-h-screen bg-gradient-animate bg-gradient-to-br from-purple-500 via-pink-500 to-purple-500 flex items-center justify-center"
    >
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
      ...
      <motion.p
        ...
        className="text-white text-xl mt-8 font-semibold sm:text-2xl md:text-3xl"
      >
